      ...
      <div className="flex-1 overflow-auto p-3 sm:p-6">
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg sm:text-2xl font-bold text-foreground">Migration Review</h2>
            ...
            <Card>
              <CardContent className="py-3 px-3 sm:px-6">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4">
                  ...
                  />
                  <Button onClick={handleMigrateSelected} disabled={!targetDate} size="sm" className="shrink-0">
                ...
                <div className="space-y-1">
                  {entries.map((entry) => (
                    ...
                    >
                      ...
                      />
                      <SignifierIcon signifier={entry.signifier} status={entry.status} className="mt-0.5 shrink-0" />
